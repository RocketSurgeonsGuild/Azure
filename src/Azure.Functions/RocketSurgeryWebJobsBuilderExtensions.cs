...
namespace Rocket.Surgery.Azure.Functions
{
    ...
    {
        internal static IContainer BuildContainer(ILogger logger, ServiceCollection services)
        {
        ...
        //public static IWebJobsBuilder AddRocketSurgery(this IWebJobsBuilder builder)
        //{
        ...
        //    var container = BuildContainer(logger, services);
